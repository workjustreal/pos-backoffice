    ...
    return (function (t) {
                            ...
                            value: function () {
                                ...
                                var o = this.options.dialogsInBody
                                    ...
                                    i = [
                                        ...
                                        ' type="file" name="files" accept="image/*" multiple="multiple"/><br>',
                                        t,
                                        "</div>",
        ...
        53: function (t, e, n) {
            ...
            var s = r.a.create('<div class="note-editor note-frame card"/>'),
                ...
                y = r.a.create(
                    '<div class="modal fade note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>',
                    function (t, e) {
                                ...
                                [
                                    ...
                                    e.title
                                        ? '<div class="modal-header"><h4 class="modal-title">' +
                                          e.title +
                                          '</h4><button type="button" class="btn-close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close"></button></div>'
                                        : "",
