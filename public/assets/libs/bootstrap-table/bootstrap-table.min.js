...
!(function (t, e) {
    ...
    var ji = w.f,
        _i = function (t) {
            return function (e) {
                for (
                    var i, n = P(e), o = ze(n), a = o.length, s = 0, r = [];
                    a > s;
                            ...
                            (this.header = {
                                ...
                                this.$header
                                    ...
                                    .on("keypress", function (e) {
                                        t.options.sortable &&
                                            i.default(e.currentTarget).data()
                                                .sortable &&
                                ...
                                this.$selectAll.prop(
                                    ...
                                    this.$selectItem.length > 0 &&
                                        this.$selectItem.length ===
                                            this.$selectItem.filter(":checked")
                                                .length
                                ),
