...
<body class="loading authentication-bg authentication-bg-pattern">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50">Return to <a href="{{route('home')}}" class="text-white ms-1"><b>Home</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
    ...
    <footer class="footer footer-alt">
        ...
        </script> &copy; Kacee Stock <a href="{{ route('home') }}" class="text-white-50">Home</a>
    </footer>
